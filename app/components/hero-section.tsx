        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="flex flex-col justify-center space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg text-emerald-50 sm:text-xl md:text-2xl">
                  Track live market prices, submit your rates, and make informed decisions
                  with the Philippines' most trusted livestock pricing platform.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <Button
                  ...
                  className="bg-white text-emerald-700 hover:bg-emerald-50 text-lg font-semibold px-8 py-6 h-auto"
                >
                  Check Prices
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-white bg-transparent text-white hover:bg-white/10 text-lg font-semibold px-8 py-6 h-auto"
                >
                  Learn More
                </Button>
              </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="rounded-xl bg-white/10 p-6 backdrop-blur-sm transition-transform hover:scale-105">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-500">
                  <TrendingUp className="h-6 w-6 text-white" />
                </div>
                <h3 className="mb-2 text-xl font-bold text-white">Live Prices</h3>
                <p className="text-sm text-emerald-50">
                  Access real-time pricing data from markets across the Philippines
                </p>
              </div>
              ...
              <div className="rounded-xl bg-white/10 p-6 backdrop-blur-sm transition-transform hover:scale-105">
                ...
                <h3 className="mb-2 text-xl font-bold text-white">Regional Insights</h3>
                <p className="text-sm text-emerald-50">
              ...
              <div className="rounded-xl bg-white/10 p-6 backdrop-blur-sm transition-transform hover:scale-105">
                ...
                <h3 className="mb-2 text-xl font-bold text-white">Market Trends</h3>
                <p className="text-sm text-emerald-50">
              ...
              <div className="rounded-xl bg-white/10 p-6 backdrop-blur-sm transition-transform hover:scale-105">
                ...
                <h3 className="mb-2 text-xl font-bold text-white">Verified Data</h3>
                <p className="text-sm text-emerald-50">
